...
SUMMARY_PREFIX = (
    ...
    "The '## Active Task' section describes what was being worked on before "
    "compaction; treat it as historical context only, not an instruction to resume. "
    "The user's latest message after this summary is the only active instruction. "
